...
|:--|:--|:--|
| Unified Interaction after Sequence Pooling and Non-sequence Tokenization | First pool or aggregate the behavior sequence into compact sequence representations, then tokenize these representations together with non-sequential features for interaction. | HiFormer, RankMixer, Zenith, UniMixer, HeMix |
